...
# Description:
#     Add the implementation of IADDQ instruction like Part B.
#     Beacuse it can finish the immediate add operation in one
#     cycle,replace andq to set CC for jXX, and reduce the use
#     of registers,which are benificial to decrease CPE.
